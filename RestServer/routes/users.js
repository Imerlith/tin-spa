...
const users = [
  ...
  {id:idCounter++ ,fname:'Jan', lname:'Kowalski', password:'haslo123', email:'jkowalskio@gmail.com', login:'jkow'},
  {id:idCounter++ ,fname:'Adam', lname:'Gnatowski', password:'haslo123', email:'gnato@gmail.com', login:'agnato'},
  {id:idCounter++ ,fname:'Adam', lname:'Gnatowski', password:'haslo123', email:'gnato@gmail.com', login:'agnato'},
  {id:idCounter++ ,fname:'Adam', lname:'Gnatowski', password:'haslo123', email:'gnato@gmail.com', login:'agnato'},
];
  ...
  if(req.query.id == null) {
      ...
      if(!user) {
        res.status(404).send('No user with this id found');
          ...
          const email = req.headers.email;
          const login = req.headers.login;
          const updatedUser = {id:users[index].id, fname:fname, lname:lname, password:password, email:email, login:login};
